 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected java.lang.String localStartData ;
                           ...
                           */
                           public  java.lang.String getStartData(){
                            ...
                            /**
                               ...
                               */
                               public void setStartData(java.lang.String param){
                            
                                            this.localStartData=param;
                           ...
                           */
                           public  int getPlaying(){
                            ...
                            /**
                               ...
                               * @param param Playing
                               */
                               public void setPlaying(int param){
                            
                                            this.localPlaying=param;
                        ...
                        */
                                    ...
                                    protected org.example.www.tournamentservice.Team[] localTeams ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localTeamsTracker = false ;

                           public boolean isTeamsSpecified(){
                               return localTeamsTracker;
                           }
                           ...
                           /**
                           * Auto generated getter method
                           * @return org.example.www.tournamentservice.Team[]
                           */
                           public  org.example.www.tournamentservice.Team[] getTeams(){
                               return localTeams;
                           }
                              ...
                              /**
                               * validate the array for Teams
                               */
                              protected void validateTeams(org.example.www.tournamentservice.Team[] param){
                              ...
                              * @param param Teams
                              */
                              public void setTeams(org.example.www.tournamentservice.Team[] param){
                              
                                   validateTeams(param);

                               localTeamsTracker = param != null;
                                      
                                      this.localTeams=param;
                              }
                             ...
                             * @param param org.example.www.tournamentservice.Team
                             */
                             public void addTeams(org.example.www.tournamentservice.Team param){
                                   if (localTeams == null){
                                   localTeams = new org.example.www.tournamentservice.Team[]{};
                                   }

                            
                                 //update the setting tracker
                                localTeamsTracker = true;
                            

                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localTeams);
                               list.add(param);
                               this.localTeams =
                             (org.example.www.tournamentservice.Team[])list.toArray(
                            new org.example.www.tournamentservice.Team[list.size()]);
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "";
                                    writeStartElement(null, namespace, "startData", xmlWriter);
                             

                                          if (localStartData==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("startData cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localStartData);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "";
                                    writeStartElement(null, namespace, "playing", xmlWriter);
                             
                                               if (localPlaying==java.lang.Integer.MIN_VALUE) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("playing cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPlaying));
                                               }
                                    
                                   xmlWriter.writeEndElement();
                              if (localTeamsTracker){
                                       if (localTeams!=null){
                                            for (int i = 0;i < localTeams.length;i++){
                                                if (localTeams[i] != null){
                                                 localTeams[i].serialize(new javax.xml.namespace.QName("","teams"),
                                                           xmlWriter);
                                                } else {
                                               ...
                                               throw new org.apache.axis2.databinding.ADBException("teams cannot be null!!");
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localSportCenter));
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("",
                                        ...
                                        if (localStartData != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localStartData));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("startData cannot be null!!");
                                        }
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPlaying));
                             if (localTeamsTracker){
                             if (localTeams!=null) {
                                 for (int i = 0;i < localTeams.length;i++){
    ...
    public static class Factory{
        ...
        */
        public static Tournament parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Tournament object =
                new Tournament();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Tournament".equals(type)){
                                ...
                                return (Tournament)org.example.www.tournamentservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list9 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","startData").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"startData" +"  cannot be null");
                                    }
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","playing").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"playing" +"  cannot be null");
                                    }
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","teams").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list9.add(org.example.www.tournamentservice.Team.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone9){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("","teams").equals(reader.getName())){
                                                                    list9.add(org.example.www.tournamentservice.Team.Factory.parse(reader));
                                                        ...
                                                        object.setTeams((org.example.www.tournamentservice.Team[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                org.example.www.tournamentservice.Team.class,
                                                                list9));

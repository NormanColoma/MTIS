 ...
 */
            ...
            /**
            *  CheckMemberResponse bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":checkMemberResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "checkMemberResponse",
    ...
    public static class Factory{
        ...
        */
        public static CheckMemberResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CheckMemberResponse object =
                new CheckMemberResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"checkMemberResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CheckMemberResponse)org.example.www.membershipservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

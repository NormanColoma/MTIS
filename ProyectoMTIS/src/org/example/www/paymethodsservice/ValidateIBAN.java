 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static ValidateIBAN parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ValidateIBAN object =
                new ValidateIBAN();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"validateIBAN".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ValidateIBAN)org.example.www.paymethodsservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

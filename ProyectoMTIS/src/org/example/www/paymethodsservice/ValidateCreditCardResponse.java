...
/**
 * ValidateCreditCardResponse.java
 *
 ...
 */
            ...
            /**
            *  ValidateCreditCardResponse bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":validateCreditCardResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "validateCreditCardResponse",
    ...
    public static class Factory{
        ...
        */
        public static ValidateCreditCardResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ValidateCreditCardResponse object =
                new ValidateCreditCardResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"validateCreditCardResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ValidateCreditCardResponse)org.example.www.paymethodsservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static ValidateNIF parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ValidateNIF object =
                new ValidateNIF();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"validateNIF".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ValidateNIF)org.example.www.validatorservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

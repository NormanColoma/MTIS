 ...
 */
            ...
            /**
            *  ValidateNIFResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ValidateNIFResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":validateNIFResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "validateNIFResponse",
    ...
    public static class Factory{
        ...
        */
        public static ValidateNIFResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ValidateNIFResponse object =
                new ValidateNIFResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"validateNIFResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ValidateNIFResponse)org.example.www.validatorservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
